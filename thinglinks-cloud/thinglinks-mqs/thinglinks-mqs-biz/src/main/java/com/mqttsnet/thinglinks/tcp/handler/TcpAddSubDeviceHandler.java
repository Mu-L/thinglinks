...
@Slf4j
@Service
public class TcpAddSubDeviceHandler extends TcpAbstractMessageHandler implements TcpTopicHandler {

    private static final ObjectMapper objectMapper = new ObjectMapper();

    public TcpAddSubDeviceHandler(LinkCacheDataHelper linkCacheDataHelper,
