...
@Slf4j
@Service
public class TcpQueryDeviceHandler extends TcpAbstractMessageHandler implements TcpTopicHandler {

    private static final ObjectMapper objectMapper = new ObjectMapper();

    public TcpQueryDeviceHandler(LinkCacheDataHelper linkCacheDataHelper,
