...
@Component
@Slf4j
public class TcpConnectEventListener {
    ...
    public void publishTcpConnectEvent(TcpConnectEvent event) {
        log.info("Publishing TCP CONNECT event: message={}", event.getMessage());
        ...
        tcpEventActionService.saveTcpEventAction(event.getMessage(), DeviceActionTypeEnum.CONNECT, describable);
    }
}
