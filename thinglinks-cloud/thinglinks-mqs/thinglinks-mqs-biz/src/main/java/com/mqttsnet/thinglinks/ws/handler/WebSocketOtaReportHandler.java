...
@Slf4j
@Service
public class WebSocketOtaReportHandler extends WebSocketAbstractMessageHandler implements WebSocketTopicHandler {

    private static final ObjectMapper objectMapper = new ObjectMapper();
    @Autowired
    private MqttEventOtaReportService mqttEventOtaReportService;

    public WebSocketOtaReportHandler(LinkCacheDataHelper linkCacheDataHelper,
