...
@Slf4j
@Service
public class TcpUpdateSubDeviceHandler extends TcpAbstractMessageHandler implements TcpTopicHandler {

    private static final ObjectMapper objectMapper = new ObjectMapper();

    public TcpUpdateSubDeviceHandler(LinkCacheDataHelper linkCacheDataHelper,
