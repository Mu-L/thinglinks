 ...
 **/
@Slf4j
public abstract class WebSocketAbstractMessageHandler {

    protected final LinkCacheDataHelper linkCacheDataHelper;
    protected final DeviceOpenAnyUserFacade deviceOpenAnyUserApi;
    protected final WebSocketBrokerOpenAnyUserFacade webSocketBrokerOpenAnyUserFacade;
    protected final ProtocolMessageAdapter protocolMessageAdapter;

    public WebSocketAbstractMessageHandler(LinkCacheDataHelper linkCacheDataHelper,
        ...
        this.webSocketBrokerOpenAnyUserFacade = webSocketBrokerOpenAnyUserFacade;
    ...
    protected void sendMessage(String topic, String clientId, String message, String tenantId) {
        ...
        webSocketBrokerOpenAnyUserFacade.sendMessage(publishMessageRequestVO);
    }
