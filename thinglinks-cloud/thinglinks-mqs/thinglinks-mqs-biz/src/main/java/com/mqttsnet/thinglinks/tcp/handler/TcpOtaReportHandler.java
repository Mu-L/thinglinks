...
import com.mqttsnet.thinglinks.tcp.service.TcpEventOtaReportService;
 ...
 * @description: 处理OTA_REPORT主题tcp.handler
 * @author: ShiHuan Sun
...
@Slf4j
@Service
public class TcpOtaReportHandler extends TcpAbstractMessageHandler implements TcpTopicHandler {

    private static final ObjectMapper objectMapper = new ObjectMapper();
    @Autowired
    private TcpEventOtaReportService tcpEventOtaReportService;

    public TcpOtaReportHandler(LinkCacheDataHelper linkCacheDataHelper,
    ...
    protected String processingTopicMessage(Object messageParam) throws Exception {
        Optional<TopoOtaReportResponseParam> topoOtaPullResponseParamOptional = tcpEventOtaReportService.handleMqttEventOtaReport((TopoOtaReportParam) messageParam);
