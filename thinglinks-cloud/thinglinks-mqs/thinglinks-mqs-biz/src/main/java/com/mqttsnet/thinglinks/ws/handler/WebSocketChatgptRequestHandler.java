...
@Slf4j
@Service
public class WebSocketChatgptRequestHandler extends WebSocketAbstractMessageHandler implements WebSocketTopicHandler {

    private static final ObjectMapper objectMapper = new ObjectMapper();

    private static Map<String, List<Message>> context = new HashMap<>();

    public WebSocketChatgptRequestHandler(LinkCacheDataHelper linkCacheDataHelper,
