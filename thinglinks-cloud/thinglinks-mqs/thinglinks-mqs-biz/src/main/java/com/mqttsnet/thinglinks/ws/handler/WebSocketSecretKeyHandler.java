...
@Slf4j
@Service
public class WebSocketSecretKeyHandler extends WebSocketAbstractMessageHandler implements WebSocketTopicHandler {

    private static final ObjectMapper objectMapper = new ObjectMapper();

    public WebSocketSecretKeyHandler(LinkCacheDataHelper linkCacheDataHelper,
    ...
    public void handle(String topic, String qos, String body) {
        ...
        try {
            ...
            // Push message to WebSocket to notify device of successful/failed secret key retrieval
