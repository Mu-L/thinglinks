...
@Slf4j
@Service
public class WebSocketOtaPullHandler extends WebSocketAbstractMessageHandler implements WebSocketTopicHandler {

    private static final ObjectMapper objectMapper = new ObjectMapper();
    @Autowired
    private MqttEventOtaPullService mqttEventOtaPullService;

    public WebSocketOtaPullHandler(LinkCacheDataHelper linkCacheDataHelper,
