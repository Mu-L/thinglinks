 ...
 * @description: TcpEventActionService
 * @author: ShiHuan Sun
...
public class TcpEventActionService {
     ...
     */
    public void saveTcpEventAction(String eventMessage, DeviceActionTypeEnum actionType, String describable) {
//        Gson gson = new Gson();
