...
@Slf4j
@Service
public class TcpDeleteSubDeviceHandler extends TcpAbstractMessageHandler implements TcpTopicHandler {

    private static final ObjectMapper objectMapper = new ObjectMapper();

    public TcpDeleteSubDeviceHandler(LinkCacheDataHelper linkCacheDataHelper,
