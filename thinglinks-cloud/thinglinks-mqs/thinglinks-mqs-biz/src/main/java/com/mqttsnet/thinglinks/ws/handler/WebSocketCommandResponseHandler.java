...
@Slf4j
@Service
public class WebSocketCommandResponseHandler extends WebSocketAbstractMessageHandler implements WebSocketTopicHandler {
    @Autowired
    private MqttEventCommandService mqttEventCommandService;

    public WebSocketCommandResponseHandler(LinkCacheDataHelper linkCacheDataHelper,
