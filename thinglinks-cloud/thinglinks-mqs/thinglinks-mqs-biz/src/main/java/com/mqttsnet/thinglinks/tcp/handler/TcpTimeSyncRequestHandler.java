...
@Slf4j
@Service
public class TcpTimeSyncRequestHandler extends TcpAbstractMessageHandler implements TcpTopicHandler {

    private static final ObjectMapper objectMapper = new ObjectMapper();

    public TcpTimeSyncRequestHandler(LinkCacheDataHelper linkCacheDataHelper,
