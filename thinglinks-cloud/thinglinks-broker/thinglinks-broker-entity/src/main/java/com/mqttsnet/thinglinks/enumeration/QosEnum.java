...
@NoArgsConstructor
@AllArgsConstructor
@Schema(title = "QosEnum", description = "Enumeration for MQTT Quality of Service (QoS) levels")
public enum QosEnum {
     ...
     */
    @Schema(description = "At most once delivery")
     ...
     */
    @Schema(description = "At least once delivery")
     ...
     */
    @Schema(description = "Exactly once delivery")
    EXACTLY_ONCE(2, "Exactly once");

    @Schema(description = "Numeric value of the QoS level")
    private Integer value;

    @Schema(description = "Description of the QoS level")
    private String desc;
