...
public interface BifroMQApi {
     ...
     */
    @PostMapping(path = "/pub", consumes = MediaType.APPLICATION_JSON_VALUE)
     ...
     */
    @PostMapping(path = "/retain", consumes = MediaType.APPLICATION_JSON_VALUE)
     ...
     */
    @DeleteMapping(path = "/session", consumes = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return ResponseEntity indicating the result of the operation.
     */
    @PutMapping(path = "/sub", consumes = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return ResponseEntity indicating the result of the operation.
     */
    @DeleteMapping(path = "/unsub", consumes = MediaType.APPLICATION_JSON_VALUE)
