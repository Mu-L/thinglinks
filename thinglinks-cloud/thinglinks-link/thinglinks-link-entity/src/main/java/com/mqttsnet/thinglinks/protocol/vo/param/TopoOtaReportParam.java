...
@Builder
@Schema(title = "TopoOtaReportParam", description = "Request Data Structure for OTA Reporting Software and Firmware Version Information")
public class TopoOtaReportParam implements Serializable {
