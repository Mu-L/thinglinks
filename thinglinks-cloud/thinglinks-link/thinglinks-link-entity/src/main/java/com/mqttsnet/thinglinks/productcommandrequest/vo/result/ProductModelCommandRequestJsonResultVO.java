...
@EqualsAndHashCode
@Builder
@Schema(title = "ProductModelCommandRequestJsonResultVO", description = "产品模型服务命令请求属性JSON参数")
public class ProductModelCommandRequestJsonResultVO implements Serializable {
