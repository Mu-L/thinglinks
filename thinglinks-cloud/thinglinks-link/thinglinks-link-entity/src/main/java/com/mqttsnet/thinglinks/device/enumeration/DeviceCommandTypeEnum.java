...
@NoArgsConstructor
@AllArgsConstructor
@Schema(title = "DeviceCommandTypeEnum", description = "Enumeration for Device Command Types")
public enum DeviceCommandTypeEnum {
    ...
    /**
     * OTA Command response.
     */
    @Schema(description = "OTA Command response")
    OTA_COMMAND_RESPONSE(2, "OTA命令下发"),
