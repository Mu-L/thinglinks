package com.mqttsnet.thinglinks.productcommandrequest.entity;
...
@Builder
@TableName(value = "product_command_request", autoResultMap = true)
public class ProductCommandRequest extends Entity<Long> {
    @Serial
