...
@EqualsAndHashCode
@Builder
@Schema(title = "ProductModelCommandResponseJsonResultVO", description = "产品模型服务命令响应属性JSON参数")
public class ProductModelCommandResponseJsonResultVO implements Serializable {
