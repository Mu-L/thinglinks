package com.mqttsnet.thinglinks.productcommandresponse.vo.query;
...
@EqualsAndHashCode
@Builder
@Schema(title = "ProductCommandResponsePageQuery", description = "产品模型服务命令属性响应参数")
public class ProductCommandResponsePageQuery implements Serializable {
