...
public class example1_genCer {
    ...
    private final String path = "./ssl";

    /**
     * CN：用户姓名或域名
     */
    private static final String CTFC_DOMAIN_NAME = "domainName";
    /**
     * OU：组织单位名称
     */
    private static final String CTFC_ORG_UNIT_NAME = "orgUnitName";
    /**
     * O：组织名称
     */
    private static final String CTFC_ORG_NAME = "orgName";
    /**
     * C：单位的两字母国家代码
     */
    private static final String CTFC_COUNTRY_CODE = "countryCode";
    /**
     * L：城市或区域
     */
    private static final String CTFC_CITY = "city";
    /**
     * ST：省份或州
     */
    private static final String CTFC_PROVINCE = "province";

    /**
     * 证书有效起始时间
     */
    private static final String CTFC_VALID_START_TIME = "validStartTime";
    /**
     * 证书有效截止时间
     */
    private static final String CTFC_VALID_END_TIME = "validEndTime";
    /**
     * 序列号域
     */
    private static final String CTFC_SERIAL_NUMBER = "serialNumber";
    /**
     * 签名算法
     */
    private static final String CTFC_SIG_AlG = "signatureAlgorithm";
    /**
     * 加密类型
     */
    private static final String CTFC_ENCRYPT_TYPE = "encryptType";
    /**
     * 加密位数
     */
    private static final String CTFC_ENCRYPT_NUM = "encryptNum";
    /**
     * //提供人
     */
    private static final String CTFC_PROVIDER = "provider";
    ...
    public boolean createBase64CerFileByDecode(HashMap<String, Object> infoMap) {
        try {
            ...
            //生成base64 cer证书文件
            FileWriter wr = new FileWriter(certPath);
