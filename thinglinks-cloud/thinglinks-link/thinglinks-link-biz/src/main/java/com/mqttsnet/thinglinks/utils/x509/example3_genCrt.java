...
public class example3_genCrt {
	...
	private static final String DN_ZHANGSAN = "CN=mqttsnet,OU=development,O=Huawei,L=BJ,ST=BJ,C=CN";
	private static final String DN_CA = "CN=mqttsnet,OU=development,O=Digicert,L=Linton,ST=Utah,C=US";
