package com.mqttsnet.thinglinks.video.dto.device;
...
@Schema(title = "VideoDeviceInfoResultDTO", description = "流媒体设备信息")
public class VideoDeviceInfoResultDTO extends Entity<Long> implements Serializable, EchoVO {
