...
import com.mqttsnet.thinglinks.video.utils.MediaServerUtils;
...
public class MediaInfo {
    ...
    public static MediaInfo getInstance(JSONObject jsonObject, VideoMediaServerResultDTO mediaServer, String serverId) {
    ...
    public static MediaInfo getInstance(OnStreamChangedHookParam param, VideoMediaServerResultDTO mediaServer, String serverId) {
