...
@Builder
@Schema(title = "VideoDeviceChannelResultVO", description = "流媒体设备通道缓存VO")
public class VideoDeviceChannelCacheVO extends Entity<Long> implements Serializable, EchoVO {
