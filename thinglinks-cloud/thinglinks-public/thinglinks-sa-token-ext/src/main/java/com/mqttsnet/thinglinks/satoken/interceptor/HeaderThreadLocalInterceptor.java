 ...
 * <p>
 * 微服务模式，必须每个服务都启用该拦截器，通过 thinglinks.webmvc.header = true 启用
 * 单体模式 必须禁用该拦截器，通过 thinglinks.webmvc.header = false 禁用
 * <p>
 *
 * @author zuihou
...
public class HeaderThreadLocalInterceptor implements AsyncHandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        ContextUtil.setToken(WebUtils.getHeader(request, ContextConstants.TOKEN_HEADER));
