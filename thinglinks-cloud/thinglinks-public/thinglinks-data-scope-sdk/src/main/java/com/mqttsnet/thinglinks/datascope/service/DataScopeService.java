package com.mqttsnet.thinglinks.datascope.service;

import cn.hutool.core.collection.CollUtil;
import com.baomidou.dynamic.datasource.annotation.DS;
import com.mqttsnet.thinglinks.common.constant.DsConstant;
import com.mqttsnet.thinglinks.datascope.entity.DefResourceDataScope;
import com.mqttsnet.thinglinks.datascope.mapper.DataScopeMapper;
 ...
 * @create [2022/4/12 9:11 AM ] [mqttsnet] [初始创建]
 */
@Slf4j
@Service
...
public class DataScopeService {
     ...
     * @return com.mqttsnet.thinglinks.datascope.entity.DefResourceDataScope
     * @author mqttsnet
     * @date 2022/10/20 10:26 AM
     * @create [2022/10/20 10:26 AM ] [mqttsnet] [初始创建]
     */
     ...
     * @create [2022/10/20 10:32 AM ] [mqttsnet] [初始创建]
     */
