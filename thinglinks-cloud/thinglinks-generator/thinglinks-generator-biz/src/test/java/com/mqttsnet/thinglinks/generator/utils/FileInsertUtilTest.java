 ...
 * @create [2022/4/20 5:15 PM ] [mqttsnet] [初始创建]
 */
public class FileInsertUtilTest {

    //测试方法
    public static void main(String[] args) {
//        FileInsertUtil ic = FileInsertUtil.of("/Users/mqttsnet/Downloads/EchoDictType.java", "String sssss = \"asfasf\";", "123131a");
//        ic.insertFile();
...
//        FileInsertUtil ic = FileInsertUtil.of("/Users/mqttsnet/Downloads/EchoDictType.java", dictRefMap);
//        String s = ic.replaceAll();
//        System.out.println(s);

//        String con = FileUtils.readFileToString(new File("/Users/mqttsnet/Downloads/EchoDictType.java"), StandardCharsets.UTF_8);
