...
import com.mqttsnet.thinglinks.generator.rules.echo.EchoDict;
...
import com.mqttsnet.thinglinks.generator.utils.inner.PackageUtils;
...
public class SourceCodeUtils {
     ...
     * @create [2022/4/6 8:55 PM ] [mqttsnet] [初始创建]
     */
     ...
     *
     * @param field field
     * @return com.mqttsnet.thinglinks.generator.rules.echo.EchoDict
     * @author mqttsnet
     * @date 2022/4/21 10:05 PM
     * @create [2022/4/21 10:05 PM ] [mqttsnet] [初始创建]
     */
