...
public interface DefGenTableService extends SuperService<Long, DefGenTable> {
     ...
     * @param ids      表id
     * @param template 模板
     * @return com.mqttsnet.basic.base.request.DownloadVO
     * @author mqttsnet
     ...
     * 获取生成项目的默认配置
     *
     * @return com.mqttsnet.thinglinks.generator.vo.save.ProjectGeneratorVO
     * @author mqttsnet
     * @date 2022/4/5 6:13 PM
     * @create [2022/4/5 6:13 PM ] [mqttsnet] [初始创建]
     */
     ...
     * 获取默认的文件覆盖策略
     *
     * @return java.util.Map<java.lang.String, com.mqttsnet.thinglinks.generator.enumeration.FileOverrideStrategyEnum>
     * @author mqttsnet
     * @date 2022/4/15 10:27 AM
     * @create [2022/4/15 10:27 AM ] [mqttsnet] [初始创建]
     * @update [2022/4/15 10:27 AM ] [mqttsnet] [变更描述]
     */
     ...
     *
     * @param idList idList
     * @return java.util.List<com.mqttsnet.thinglinks.generator.vo.result.DefGenTableResultVO>
     * @author mqttsnet
     * @date 2022/6/13 9:43 AM
     * @create [2022/6/13 9:43 AM ] [mqttsnet] [初始创建]
     * @update [2022/6/13 9:43 AM ] [mqttsnet] [变更描述]
     */
     ...
     * @create [2022/6/14 8:56 PM ] [mqttsnet] [初始创建]
     * @update [2022/6/14 8:56 PM ] [mqttsnet] [变更描述]
     */
