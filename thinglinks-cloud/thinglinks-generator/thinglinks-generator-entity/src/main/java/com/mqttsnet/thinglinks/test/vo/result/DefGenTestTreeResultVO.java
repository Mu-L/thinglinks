...
import com.mqttsnet.thinglinks.test.enumeration.DefGenTestTreeType2Enum;
...
public class DefGenTestTreeResultVO extends TreeEntity<DefGenTestTreeResultVO, Long> implements Serializable, EchoVO {
    ...
    @Echo(api = EchoApi.DICTIONARY_ITEM_FEIGN_CLASS, dictType = EchoDictType.Base.DefGenTestTreeType2Enum)
     ...
     * 字符字典;
     *
     * @Echo(api = "com.mqttsnet.thinglinks.common.api.DictApi", dictType="GLOBAL_SEX")
     */
