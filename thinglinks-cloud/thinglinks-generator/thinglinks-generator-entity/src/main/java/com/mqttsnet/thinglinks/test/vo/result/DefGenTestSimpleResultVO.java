package com.mqttsnet.thinglinks.test.vo.result;
...
import com.mqttsnet.thinglinks.test.enumeration.DefGenTestSimpleType2Enum;
import com.mqttsnet.thinglinks.test.enumeration.ProductType;
...
public class DefGenTestSimpleResultVO extends Entity<Long> implements Serializable, EchoVO {
    ...
    @Echo(api = EchoApi.DICTIONARY_ITEM_FEIGN_CLASS, dictType = EchoDictType.Base.ProductType)
    ...
    @Echo(api = EchoApi.DICTIONARY_ITEM_FEIGN_CLASS, dictType = EchoDictType.Base.DefGenTestSimpleType2Enum)
     ...
     * 字符字典;
     *
     * @Echo(api = "com.mqttsnet.thinglinks.oauth.api.DictionaryApi", dictType="GLOBAL_SEX")
     */
