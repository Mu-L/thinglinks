package com.mqttsnet.thinglinks.generator.vo.save;
...
public class ProjectGeneratorVO implements Serializable {
     ...
     * 服务名
     * <p>
     * 如： thinglinks-base-server 中的base
     * 如： thinglinks-system-server system
     */
     ...
     * 如： com.mqttsnet.thinglinks.file.dao.xxx 包中的 file
     */
    @NotEmpty(message = "请填写模块名")
    private String moduleName;

    /**
     * thinglinks项目 生成代码位于 src/main/java 下的基础包
     ...
     * @create [2022/4/5 2:34 PM ] [mqttsnet] [初始创建]
     * @update [2022/4/5 2:34 PM ] [mqttsnet] [变更描述]
     */
