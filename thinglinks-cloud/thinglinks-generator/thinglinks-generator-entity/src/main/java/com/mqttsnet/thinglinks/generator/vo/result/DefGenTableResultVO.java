package com.mqttsnet.thinglinks.generator.vo.result;
...
public class DefGenTableResultVO extends Entity<Long> implements Serializable, EchoVO {
    ...
    @Echo(api = EchoApi.DICTIONARY_ITEM_FEIGN_CLASS, dictType = EchoDictType.Base.EntitySuperClassEnum)
    ...
    @Echo(api = EchoApi.DICTIONARY_ITEM_FEIGN_CLASS, dictType = EchoDictType.Base.SuperClassEnum)
    ...
    @Echo(api = EchoApi.DICTIONARY_ITEM_FEIGN_CLASS, dictType = EchoDictType.Base.GenTypeEnum)
    ...
    @Echo(api = EchoApi.DICTIONARY_ITEM_FEIGN_CLASS, dictType = EchoDictType.Base.TplEnum)
    ...
    @Echo(api = EchoApi.DICTIONARY_ITEM_FEIGN_CLASS, dictType = EchoDictType.Base.PopupTypeEnum)
