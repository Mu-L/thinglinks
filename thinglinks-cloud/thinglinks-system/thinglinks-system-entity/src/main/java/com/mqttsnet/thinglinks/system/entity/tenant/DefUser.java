...
public class DefUser extends Entity<Long> {
     ...
     * 用户名;大小写数字下划线
     */
    @TableField(value = "username", condition = EQUAL, typeHandler = EncryptTypeHandler.class)
    private String username;

    /**
     * 姓名
     */
    @TableField(value = "nick_name", condition = EQUAL, typeHandler = EncryptTypeHandler.class)
    private String nickName;

    /**
     * 邮箱
     */
    @TableField(value = "email", condition = EQUAL, typeHandler = EncryptTypeHandler.class)
    private String email;

    /**
     * 手机;1开头11位纯数字
     */
    @TableField(value = "mobile", condition = EQUAL, typeHandler = EncryptTypeHandler.class)
    private String mobile;

    /**
     * 身份证;15或18位
     */
    @TableField(value = "id_card", condition = EQUAL, typeHandler = EncryptTypeHandler.class)
