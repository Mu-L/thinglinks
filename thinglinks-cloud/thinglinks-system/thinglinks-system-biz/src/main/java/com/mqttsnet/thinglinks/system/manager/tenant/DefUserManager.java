...
public interface DefUserManager extends SuperCacheManager<DefUser>, LoadService {
     ...
     * @param pageQuery 参数
     * @param page      分页参数
     * @return {IPage<DefUser>} 分页结果
     */
    IPage<DefUser> selectNotUserByTenantId(DefUserPageQuery pageQuery, IPage<DefUser> page);
     ...
     * @return {IPage<DefUser>} 分页结果
     */
    IPage<DefUser> pageUserByTenant(DefUserPageQuery pageQuery, IPage<DefUser> page);
