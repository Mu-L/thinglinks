package com.mqttsnet.thinglinks.template.vo.update;
...
@EqualsAndHashCode
@Builder
@Schema(title = "ProjectTemplateUpdateVO", description = "可视化项目模板表")
public class ProjectTemplateUpdateVO implements Serializable {
