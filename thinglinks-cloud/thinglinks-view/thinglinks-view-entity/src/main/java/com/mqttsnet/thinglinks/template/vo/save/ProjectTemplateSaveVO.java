package com.mqttsnet.thinglinks.template.vo.save;
...
@EqualsAndHashCode
@Builder
@Schema(title = "ProjectTemplateSaveVO", description = "可视化项目模板表")
public class ProjectTemplateSaveVO implements Serializable {
    ...
    @Size(max = 255, message = "模版标识长度不能超过{max}")
