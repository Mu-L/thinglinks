...
/**
 * -----------------------------------------------------------------------------
 * File Name: DeviceActionRightParamsDTO.java
 * -----------------------------------------------------------------------------
 * Description:
 * 设备属性右操作参数定义
 * -----------------------------------------------------------------------------
...
@EqualsAndHashCode
@Builder
@Schema(title = "DeviceActionRightParamsDTO", description = "参数定义，用于条件比较的右操作参数数据")
public class DeviceActionRightParamsDTO implements Serializable {
    @Serial
