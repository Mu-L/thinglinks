...
import com.mqttsnet.thinglinks.base.vo.query.user.BaseOrgPageQuery;
import com.mqttsnet.thinglinks.base.vo.result.user.BaseOrgResultVO;
import com.mqttsnet.thinglinks.base.vo.save.user.BaseOrgRoleRelSaveVO;
...
public interface BaseOrgService extends SuperCacheService<Long, BaseOrg> {
     ...
     * @return java.util.List<com.mqttsnet.thinglinks.base.entity.user.BaseOrg>
     * @author mqttsnet
     * @date 2022/10/26 10:59 PM
     * @create [2022/10/26 10:59 PM ] [mqttsnet] [初始创建]
     */
     ...
     * @create [2022/10/26 10:29 PM ] [mqttsnet] [初始创建]
     */
     ...
     * @return com.mqttsnet.thinglinks.base.entity.user.BaseOrg
     * @author mqttsnet
     * @date 2022/10/26 10:27 PM
     * @create [2022/10/26 10:27 PM ] [mqttsnet] [初始创建]
     */
