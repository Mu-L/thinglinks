...
<script lang="ts">
  ...
  import { Api } from '/@/api/devOperation/sop/sopNotifyInfo';
  import { getValidateRules } from '/@/api/thinglinks/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './sopNotifyInfo.data';
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const [registerForm, { setFieldsValue, resetFields, updateSchema, resetSchema }] = useForm({
        name: 'SopNotifyInfoEdit',
        labelWidth: 100,
