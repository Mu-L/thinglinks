...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/devOperation/system/defParameter';
  import { getValidateRules } from '/@/api/thinglinks/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './defParameter.data';

  export default defineComponent({
    name: 'DefParameterEdit',
