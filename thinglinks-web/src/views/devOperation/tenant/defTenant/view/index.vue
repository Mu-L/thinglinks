  ...
  <PageWrapper contentBackground>
    <template #footer>
      <a-tabs
        ...
        "
      >
        <a-tab-pane key="1" :tab="t('devOperation.tenant.defTenant.tenantInfo')" />
        <a-tab-pane key="2" :tab="t('devOperation.tenant.defTenant.tenantApplication')" />
        <a-tab-pane key="3" :tab="t('devOperation.tenant.defTenant.tenanUser')" />
      </a-tabs>
    </template>
