...
<script lang="ts">
  ...
  import { getValidateRuleObj } from '/@/api/thinglinks/common/formValidateService';
      ...
      const gridOptions = reactive<VxeGridProps>({
        ...
        toolbarConfig: {
          ...
          buttons: [
            ...
            { code: 'save', name: t('devOperation.ops.defInterface.submit'), status: 'success' },
          ],
        },
        // 分页配置项
        pagerConfig: {
          ...
          ajax: {
            ...
            query: ({ page, sorts, filters, form }) => {
              ...
              if (!interfaceId.value) {
                createMessage.warn(t('common.PleaseSaveDataFirst'));
                return Promise.reject(t('common.PleaseSaveDataFirst'));
              }
              // 处理排序条件
