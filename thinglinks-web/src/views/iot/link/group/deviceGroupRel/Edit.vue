...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/iot/link/group/deviceGroupRel';
  import { getValidateRules } from '/@/api/thinglinks/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './deviceGroupRel.data';
