<template>
  <PageWrapper class="high-form" title="编辑CA许可证证书" contentBackground contentClass="p-4">
    <template #extra>
      <a-button
        :loading="loading"
...
<script lang="ts">
  ...
  import { customFormSchemaRules, editFormSchema } from './caCertLicense.data';
