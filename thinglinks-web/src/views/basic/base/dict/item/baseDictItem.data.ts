...
import { stateFilters, stateComponentProps, dictComponentProps } from '/@/utils/thinglinks/common';
  ...
  return [
    {
      ...
      colProps: { span: 12 },
      componentProps: {
        ...dictComponentProps(DictEnum.DictClassifyEnum),
        mode: 'multiple',
      },
    },
    {
      ...
      rules: [
        {
          ...
          async validator(_, value) {
            ...
            if (value && (await check(value, model?.parentId, model?.id))) {
