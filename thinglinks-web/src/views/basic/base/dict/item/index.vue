      ...
      <template #bodyCell="{ column, record }">
        <template v-if="column.dataIndex === 'state'">
          <Badge
            ...
            :text="record.state ? t('thinglinks.common.enable') : t('thinglinks.common.disable')"
          />
        </template>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys, setTableData }] = useTable({
        title: () => {
          return dict.name ? t('basic.base.baseDict.dictTitle', {name: dict.name}) : t('basic.base.baseDict.pleaseSelectDict');
        },
        api: page,
        columns: columns(),
        formConfig: {
