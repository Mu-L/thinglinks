<template>
  <PageWrapper class="high-form" contentBackground contentClass="p-4" :title="t('basic.system.baseMessage.publishMessage')">
    ...
    <template #rightFooter>
      ...
      >
        {{ t('basic.system.baseMessage.saveDraft') }}
      </a-button>
      <a-button
        v-if="type !== ActionEnum.VIEW"
        class="ml-4"
      ...
      >
        {{ t('basic.system.baseMessage.sendNow') }}
      </a-button>
    </template>
  </PageWrapper>
</template>
