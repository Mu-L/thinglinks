...
export function useFormRules(formData?: Recordable) {
  ...
  const validateSliderVerify = async (_: RuleObject, value: boolean) => {
    return !value ? Promise.reject(t('component.verify.dragText')) : Promise.resolve();
  };
  ...
  const getFormRules = computed((): { [k: string]: ValidationRule | ValidationRule[] } => {
    ...
    const loginRule = {
      ...
      sliderVerified: [{ validator: validateSliderVerify, trigger: 'change' }],
    };
