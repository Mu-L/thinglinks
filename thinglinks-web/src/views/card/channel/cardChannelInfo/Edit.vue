...
import { Api, save, update, copy } from '/@/api/card/channel/cardChannelInfo';
import { getValidateRules } from '/@/api/thinglinks/common/formValidateService';
import { customFormSchemaRules, editFormSchema } from './cardChannelInfo.data';
