export enum RoleEnum {
  ...
  // 设备
  LINK_DEVICE_DEVICE_VIEW = 'link:device:device:view', // 查看设备

  // 设备分组详情
  LINK_GROUP_DEVICEGROUPREL_ADD = 'link:group:deviceGroupRel:add', // 分组增加设备信息
  LINK_GROUP_DEVICEGROUPREL_EDIT = 'link:group:deviceGroupRel:edit', // 编辑分组设备备注
  LINK_GROUP_DEVICEGROUPREL_DELETE = 'link:group:deviceGroupRel:delete',
}
