export default {
  ...
  login: {
    ...
    signInDesc: 'Internet of Things integration platform',
    policy: 'I agree to the ThingLinks Privacy Policy',
    ...
    // error messages
    captchaTooFrequent: 'Captcha requests are too frequent, please try again after 1 minute',
