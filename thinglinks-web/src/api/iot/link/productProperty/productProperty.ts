...
} from './model/productPropertyModel';
...
export const Api = {
  ...
  Save: {
    url: `${ServicePrefix}/${MODULAR}/saveProductProperty`,
    method: RequestEnum.POST,
  } as AxiosRequestConfig,
  Update: {
    url: `${ServicePrefix}/${MODULAR}/updateProductProperty`,
