        ...
        >
          <div class="card_wrap">
            <div class="left_info">
              ...
              <div class="btns">
                <div class="btn" v-hasAnyPermission="['video:media:videoStreamPush:delete']">
                ...
                <div class="btn">
                  <a-tooltip
                    ...
                    v-hasAnyPermission="['video:media:videoStreamPush:edit']"
                  >
                    <img
                      alt=""
                ...
                <!-- <div class="btn">
                  <a-tooltip placement="top" :title="t('video.device.videoDeviceInfo.play')">
                    <img
                      alt=""
            ...
            <img
              ...
              src="/@/assets/images/video/device/videoDeviceInfo/video-evice-channel.jpg"
              alt=""
...
<script setup lang="ts">
  ...
  import EditModal from '/@/views/video/device/videoDeviceChannel/Edit.vue';
