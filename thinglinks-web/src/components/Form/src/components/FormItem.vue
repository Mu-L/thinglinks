<script lang="tsx">
  ...
  import { RuleType } from '/@/api/thinglinks/common/formValidateService';
    ...
    setup(props, { slots }) {
      ...
      function renderLabelHelpMessage() {
        ...
        const renderLabel = subLabel ? (
          <span class="basic-form-item-label">
            {label} <span class="text-secondary">{subLabel}</span>
          </span>
        ) : (
          <span class="basic-form-item-label">{label}</span>
        );
