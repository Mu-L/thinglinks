<template>
  ...
  <CollapseItem v-for="(item, index) in seriesList" :key="index" :name="`${t('components.charts.lineChart')}-${index + 1}`" :expanded="true">
    <SettingItemBox :name="t('components.common.line')">
      ...
      <SettingItem :name="t('components.common.type')">
        <n-select v-model:value="item.lineStyle.type" size="small" :options="lineConf.lineStyle.type"></n-select>
      </SettingItem>
    </SettingItemBox>
    <SettingItemBox :name="t('components.common.solidPoint')">
      <SettingItem :name="t('components.common.size')">
        <n-input-number
