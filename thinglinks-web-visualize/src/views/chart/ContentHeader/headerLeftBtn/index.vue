...
const btnList = reactive<ItemType<ChartLayoutStoreEnum>[]>([
  {
    ...
    select: getCharts,
    title: t('project.chart_components'),
    icon: renderIcon(BarChartIcon)
  },
  {
    key: ChartLayoutStoreEnum.LAYERS,
    select: getLayers,
    title: t('project.layer_control'),
    icon: renderIcon(LayersIcon)
  },
  {
    key: ChartLayoutStoreEnum.DETAILS,
    select: getDetails,
    title: t('project.detail_settings'),
...
const goHomeHandle = () => {
  goDialog({
    message: t('project.confirm_save_and_return'),
    isMaskClosable: true,
    onPositiveCallback: () => {
      goHome()
      useRemoveKeyboard()
