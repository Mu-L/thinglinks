...
// * 默认多选组件选项
export const getDefaultMultiSelectOptions = (): MenuOptionsItemType[] => [
  {
    label: getT('project.create_group'),
    key: MenuEnum.GROUP,
    icon: renderIcon(Carbon3DSoftwareIcon),
    fnHandle: chartEditStore.setGroup
  },
  {
    label: getT('project.ungroup'),
...
const handleContextMenu = (
  ...
  // * 多选默认选项
  const defaultMultiSelectOptions = getDefaultMultiSelectOptions()
...
export const useContextMenu = () => {
  // 设置默认项
  menuOptions.value = getDefaultOptions()
  ...
  return {
    ...
    defaultMultiSelectOptions: getDefaultMultiSelectOptions(),
    handleContextMenu,
    onClickOutSide,
    handleMenuSelect,
